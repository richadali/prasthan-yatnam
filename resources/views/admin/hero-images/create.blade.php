...
@section('title', 'Add New Hero Image')
    ...
    <div class="card border-0 shadow-sm">
        <div class="card-header bg-white py-3">
            <div class="d-flex justify-content-between align-items-center">
                <h5 class="mb-0">Upload Hero Image</h5>
        ...
        <div class="card-body">
            <form action="{{ route('admin.hero-images.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row mb-4">
                    <div class="col-md-6">
                        <div class="mb-3">
                            <label for="image" class="form-label">Hero Image <span class="text-danger">*</span></label>
                            <input type="file" class="form-control @error('image') is-invalid @enderror" id="image"
                                name="image" accept="image/*" required onchange="validateFileSize(this, 2)">
                ...
                <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                    ...
                    <button type="submit" class="btn btn-primary">
                        <i class="fas fa-save me-2"></i>Save Hero Image
                    </button>
                </div>
            </form>
        </div>
